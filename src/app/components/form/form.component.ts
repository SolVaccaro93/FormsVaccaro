...
export class FormComponent implements OnInit {
  ...
  constructor(
    ...
    this.formularioRegistro = this.fb.group({
      ...
      localidad: ['', [Validators.required, Validators.minLength(3), Validators.maxLength(15)]],
      nacimiento: ['', [Validators.required]],
      email: ['', [Validators.email, Validators.required]],
      contraseña: ['', [Validators.required, Validators.minLength(8), Validators.maxLength(15)]],
      checkpassword: ['', [Validators.required, Validators.minLength(8), Validators.maxLength(15)]]
    },
